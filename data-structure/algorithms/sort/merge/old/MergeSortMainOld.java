...
public class MergeSortMainOld extends InsertionSortPopulate {
	public static void main(String[] args) {
		sort.MergeSort mergeSort = new MergeSort();
		/*SelectionSortPopulate population = new SelectionSortPopulate();
