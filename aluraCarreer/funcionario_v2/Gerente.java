...
public class Gerente extends Funcionario {
	...
	//reescrita do método getBonificação que tem na classe pai funcionário
	public double getBonificacao() {
		//o super indica que o atributo não está definido nesta classe e sim na super classe (a classe pai), que no caso é a Funcionário
